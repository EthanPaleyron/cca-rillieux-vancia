...
<div class="equipe">
    ...
    <div>
        <article>
            <img src="../assets/images/equipier/jean-jacques.jpg" alt="Jean Jacques">
            <h2>Jean-Jacques</h2>
        ...
        <article>
            <img src="../assets/images/equipier/andre.jpg" alt="André">
            <h2>André</h2>
            <p>Vice président
                Une connaissance du club sans pareil, c’est notre sage.</p>
        </article>
        <article>
            <img src="../assets/images/equipier/annabel.jpg" alt="Annabel">
            <h2>Annabel</h2>
        ...
        <article>
            <img src="../assets/images/equipier/cyrille.jpg" alt="Cyrille">
            <h2>Cyrille</h2>
        ...
        <article>
            <img src="../assets/images/equipier/fabrice.jpg" alt="Fabrice">
            <h2>Fabrice</h2>
            <p>Encadrant chiens adultes
                Avec lui c’est fou rire assuré pendant les cours !</p>
        </article>
        <article>
            <img src="../assets/images/equipier/noelle.jpg" alt="Noëlle">
            <h2>Noëlle</h2>
            <p>Trésorière
                Il paraît que sa chienne est la première de la classe en cours ;)</p>
        </article>
        <article>
            <img src="../assets/images/equipier/antonio.jpg" alt="Antonio">
            <h2>Antonio</h2>
            <p>Notre Mc Gyver
