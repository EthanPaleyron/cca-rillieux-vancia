...
const infosCarrousel = [
  {
    ...
    contenues: `<h3><i class="fa-solid fa-paw"></i>éducation des chiots :</h3>
    <p>L'éducation du chiot est la clé de son évolution de ses 2 mois à ses 12 mois. Un petit toutou bien éduqué fera un chien adulte obéissant et agréable à vivre. 
  ...
  },
  {
    ...
    <p>Activité que nous pratiquons en loisir et compétition. Le principe est simple, une ou plusieurs personnes s'égarent volontairement sur une certaine distance. 
    Après un certain délai le chien grâce à son flair devra, en suivant les indications de son maître, la retrouver et l'identifier. Cette discipline qui se veut ludique, contient des épreuves de recherche mais aussi de dextérité tel que porter son chien, passage de passerelles, tunnels... 
    ...
    Nous avons la chance de pouvoir bénéficier du fort de Vancia pour les formations et compétitions.</p>`,
  },
  {
    img: "obeissance.jpg",
    titre: "Obeissance",
    ...
    Elle révèle la complicité du chien avec son maître et met en valeur ses qualités naturelles. La plupart des races canines y ont accès, l'âge des chiens pour la présentation est de 12 mois.
